# /// orcheo
# name = "WeCom Event Agent (Pure Agent)"
# handle = "wecom-event-agent-pure"
# description = "Manage WeCom events and RSVPs using a single tool-using agent."
# entrypoint = "build_graph"
# emoji = "📅"
# subtitle = "WeCom Agent"
# ///
