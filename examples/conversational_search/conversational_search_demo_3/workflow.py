# /// orcheo
# name = "Conversational Search Demo 3: Hybrid Search"
# handle = "conversational-search-demo-3"
# description = "Retrieve and fuse dense and sparse results over Pinecone indexes."
# config = "./config.json"
